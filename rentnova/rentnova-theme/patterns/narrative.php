<?php
/**
 * Title: RentNova: Narrative + side facts
 * Slug: rentnova/narrative
 * Categories: rentnova
 * Description: Two-column long-form story (left) with a paper-tone side-facts aside (right).
 * Keywords: narrative, story, about
