 ...
 * 5KB once, silently. A file cannot be half-saved by a browser.
 *
 * As an mu-plugin it loads automatically, before ordinary plugins, and cannot be
 * switched off by WPCode's error handling -- which deactivated the snippet over
 * a single PHP warning on one page, taking every shortcode, the checkout and the
 * Stripe webhook down with it.
 *
 * IF THIS FILE IS IN USE, KEEP WPCODE SNIPPET 32391 DEACTIVATED, and vice versa.
 * Two live copies do not merge: the double-load guard skips whichever loads
 * second, silently. [aa_reg_selftest] prints which copy is running.
 */
...
function aa_reg_strings() {
	return array(
		...
		'ar' => array(
			...
			'bar_note'         => 'مدة الدورة موضحة من خلال المربع المظلل، بما في ذلك عطلة نهاية الأسبوع',
			...
			'days_l'           => 'أيام',
			'duration'         => 'المدة',
			'filter_cert'      => 'تخصيص العرض',
			'find_cert'        => 'البحث عن الشهادة المناسبة',
			'format'           => 'الصيغة',
			'from_price'       => 'ابتداءً من',
			'full_details'     => 'كامل التفاصيل',
			'leads_to'         => 'يدل على',
			'n_more_classes'   => '+%d أخرى هذا الأسبوع',
			'next_ainative'    => 'إذا أردت أن تصبح مدربا محترفا AI-Native',
			'next_month'       => 'الشهر القادم',
			'next_progress'    => 'يمكنك القيام ب',
			'next_start'       => 'أقرب موعد',
			'one_cohort'       => 'موعد الدورة',
			'other_dates'      => 'أوقات أخرى',
			'prev_month'       => 'الشهر الماضي',
			'progress_to'      => 'التقدم إلى',
			'register_now'     => 'سجّل',
			'resched'          => 'تغيير الموعد بدون رسوم',
			'seats_left_n'     => 'بقي %d مقعد',
			'selected_cohort'  => 'الاختيار الحالي',
			'today'            => 'اليوم',
			'upcoming_cohorts' => 'التواريخ المتاحة',
			'weeks_ltr'        => 'الأسابيع مرتبة أفقيًا',
			'youll_learn'      => 'مالذي سوف تتعلمه',
			'next_batch'    => 'الدورة القادمة',
			'investment'    => 'المبلغ المترتب',
			'exam_included' => 'الامتحان مشمول بالرسوم',
			'pick_dates'    => 'اختر التواريخ المناسبة لك',
			'batch_1'       => 'الدوره المختاره',
			'batch_n'       => '%d دورات مجدولة',
			'full_schedule' => 'عرض الجدول الكامل',
			'no_dates'      => 'في حاله أن التزواريخ المسجله لا تناسبك',
			'private'       => 'التقدم بطلب لمواعيد اخرى',
			'scroll'        => 'اضغط هنا لعرض جدول التواريخ بالكامل',
			'scroll_x'      => 'الانتقال لأسفل الصفحه',
			'trained'       => 'متدرب',
			'arts'          => 'ARTs launched',
			'exam_fee'      => 'رسوم الامتحان',
			'included'      => 'مشمولة',
			'skip_form'     => 'الانتقال الفوري للتسجيل',
			'all_batches'   => 'كل الدورات',
			'weekday'       => 'أيام الأسبوع',
			'weekend'       => 'عطلة نهاية الأسبوع',
			'show_all'      => 'عرض كل الدورات',
			'no_match'      => 'نعتذر منك عن عدم توفر التواريخ',
			...
			'selected'      => 'اختر اقرب توقيت متاح',
			'your_email'    => 'بريدك الإلكتروني',
			'seats'         => 'المقاعد',
			'total'         => 'الإجمالي',
			'continue'      => 'انتقل لمرحله المراجعه',
			'enter_email'   => 'يرجى إدخال البريد الالكتروني الخاص بك',
			'course'        => 'الدورة',
			'dates'         => 'التواريخ',
			'email'         => 'البريد الإلكتروني',
			'total_exam'    => 'الإجمالي · رسوم الامتحان مشمولة',
			'pay'           => 'ادفع مع Stripe براحة بال',
			'pay_off'       => 'نعتذر منك التسجيل غير متاح حاليا',
			'book_another'  => 'إضافة تسجيل آخر',
			'fine'          => 'في حال الطلب لتغيير الوقت، يمكنك ظلب ذلك بدون دفع أي وسوم إضافيه',
			'step_details'  => 'بياناتك',
			'step_pay'      => 'التاكد من المعلومات قبل الدفع',
			'next_avail'    => 'اقرب تاريخ متاح',
			'seats_left'    => 'بقي %d مقاعد',
			'seats_open'    => 'مقاعد متاحة',
			'week_of'       => 'أسبوع',
			'batch_weekend' => 'الاوقات خلال عطلة نهايه الاسبوع',
...
function aa_reg_menu_labels() {
	return array(
		...
		'Product Operating Model'   => array( 'fr' => 'Modèle opérationnel produit','es' => 'Modelo operativo de producto', 'ar' => 'نظام التشغيل للمنتجات' ),
		'Operating Model in the Age of AI' => array( 'fr' => 'Le modèle opérationnel à l’ère de l’IA', 'es' => 'Modelo operativo en la era de la IA', 'ar' => 'نظام التشغيل في عصر الذكائ الاصطناعي' ),
		...
		'Achieving Responsible AI'  => array( 'fr' => 'Une IA responsable',        'es' => 'IA responsable',            'ar' => 'الذكاء الاصطناعي الذي يمكنك الوثوق به' ),
		'Agile Maturity'            => array( 'fr' => 'Maturité Agile',            'es' => 'Madurez Agile',             'ar' => 'تحديد مستوى المعرفة عن Agile' ),
