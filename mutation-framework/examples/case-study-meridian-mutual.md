# Case Study: Meridian Mutual

**Type:** Neutral / mixed · **Status:** v1.0-draft (composite/illustrative — flag for owner review)
**Profile:** ~1,200-person regional insurance mutual
...
Most framework writing showcases triumphs and train wrecks. Meridian Mutual
is the more common reality: a disciplined organization that adopted the
framework competently, improved where its structure allowed, and plateaued
where its structure pushed back. Eighteen months in, the honest verdict is
**genuinely better, and not yet mutation-ready** — and the case is useful
precisely for showing which parts of the framework deliver under
constraint and which parts demand changes an organization may legitimately
decline to make.
...
**Sensing was nearly free.** The SignalNet and weekly review fit an
...
choice; it is that the choice was made *on the record, against named
dimensions, with a revisit date* — which is what separates a strategy from
a drift.
